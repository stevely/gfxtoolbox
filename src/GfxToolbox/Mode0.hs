...
import GfxToolbox.Mode0.Shaders
...
mkSpriteProgram = do
    ...
    lift $ do
        ...
        return (SpriteProgram prog vao vbo screenSize texSampler)

loadSpriteSheets :: GLuint -> [FilePath] -> EitherT String IO TextureUnit
loadSpriteSheets = flip loadTextureArray
